...
#     select_seq_sql = f"""
#     SELECT SEQ_NUM FROM SIT_ALDM.ALDM_OPER.EXTRACT_SEQ_TRACK
...
lv_extract_location = '/Volumes/sit_aldm/aldm_oper/mft-out/aldm/outbound_1/B2C_DEALER_DETAILED_STATEMENT_PAYM'
