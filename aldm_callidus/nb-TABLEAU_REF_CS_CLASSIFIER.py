...
DELETE FROM {sfReportingDatabase}.PRS_SPL_DP.CS_CLASSIFIER;
...
INSERT INTO {sfReportingDatabase}.PRS_SPL_DP.CS_CLASSIFIER
(
	TENANTID,
	CLASSIFIERSEQ,
	EFFECTIVESTARTDATE,
...
SRC.INSERT_TS,
SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_CLASSIFIER SRC
;
