...
query = f"""
DELETE FROM {sfReportingDatabase}.PRS_SPL_DP.CS_EVENTTYPE;
...
query = f"""
INSERT INTO {sfReportingDatabase}.PRS_SPL_DP.CS_EVENTTYPE
(
	TENANTID,
	DATATYPESEQ,
	EVENTTYPEID,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_EVENTTYPE SRC
;
