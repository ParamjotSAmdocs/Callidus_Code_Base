...
query = f"""
TRUNCATE TABLE {sfDatabase}.ATO_CEG_STG.TBL_PRS_PRICEBOOK_COMMISSIONS;
...
query = f"""
INSERT INTO {sfDatabase}.ATO_CEG_STG.TBL_PRS_PRICEBOOK_COMMISSIONS
(
	SOURCE_TABLE,
	MDLT_NAME,
	EFFECTIVE_START_DT,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.TBL_PRS_PRICEBOOK_COMMISSIONS_STG SRC
WHERE SRC.INSERT_TS = (
	SELECT MAX(INSERT_TS)
	FROM {sfDatabase}.ATO_CEG_STG.TBL_PRS_PRICEBOOK_COMMISSIONS_STG
)
;
