...
query = f"""
TRUNCATE TABLE {sfDatabase}.ATO_CEG_STG.CS_TRANSACTIONADDRESS;
...
INSERT INTO {sfDatabase}.ATO_CEG_STG.CS_TRANSACTIONADDRESS
(
 TENANTID 
...
SELECT 
 ...
 ,SRC.INSERT_TS 
 ,SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_TRANSACTIONADDRESS_STG SRC
WHERE SRC.INSERT_TS = (
 SELECT MAX(INSERT_TS)
 FROM {sfDatabase}.ATO_CEG_STG.CS_TRANSACTIONADDRESS_STG
)
; 
