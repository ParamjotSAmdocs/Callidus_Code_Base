...
DELETE FROM {sfReportingDatabase}.PRS_SPL_DP.CS_CATEGORY_CLASSIFIERS;
...
INSERT INTO {sfReportingDatabase}.PRS_SPL_DP.CS_CATEGORY_CLASSIFIERS
(
	TENANTID,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_CATEGORY_CLASSIFIERS SRC
;
