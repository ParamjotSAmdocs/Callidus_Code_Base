...
query = f"""
DELETE FROM {sfReportingDatabase}.PRS_SPL_DP.CS_CALENDAR;
...
query = f"""
INSERT INTO {sfReportingDatabase}.PRS_SPL_DP.CS_CALENDAR
(
	TENANTID,
	CALENDARSEQ,
	CREATEDATE,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_CALENDAR SRC
;
