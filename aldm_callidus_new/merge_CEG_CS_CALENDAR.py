...
query = f"""
TRUNCATE TABLE {sfDatabase}.ATO_CEG_STG.CS_CALENDAR;
...
query = f"""
INSERT INTO {sfDatabase}.ATO_CEG_STG.CS_CALENDAR
(
	TENANTID,
	CALENDARSEQ,
	CREATEDATE,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_CALENDAR_STG SRC
WHERE SRC.INSERT_TS = (
	SELECT MAX(INSERT_TS)
	FROM {sfDatabase}.ATO_CEG_STG.CS_CALENDAR_STG
)
;
