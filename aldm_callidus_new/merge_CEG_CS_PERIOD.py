...
query = f"""
TRUNCATE TABLE {sfDatabase}.ATO_CEG_STG.CS_PERIOD;
...
query = f"""
INSERT INTO {sfDatabase}.ATO_CEG_STG.CS_PERIOD
(
	TENANTID,
	PERIODSEQ,
	CREATEDATE,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_PERIOD_STG SRC
WHERE SRC.INSERT_TS = (
	SELECT MAX(INSERT_TS)
	FROM {sfDatabase}.ATO_CEG_STG.CS_PERIOD_STG
)
;
