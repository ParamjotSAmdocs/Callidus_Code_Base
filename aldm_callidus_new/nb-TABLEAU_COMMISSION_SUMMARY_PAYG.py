...
DELETE FROM {sfReportingDatabase}.PRS_SPL_DP.COMMISSION_SUMMARY_PAYG;
...
INSERT INTO {sfReportingDatabase}.PRS_SPL_DP.COMMISSION_SUMMARY_PAYG
SELECT
BUS_SERVICE_TYPE,
LOB,
PAYMENT_MONTH,
...
TOTAL_PAYMENT,
VB_FLAG
FROM {sfDatabase}.PRS_CEG_EXT.COMMISSION_SUMMARY_PAYG
