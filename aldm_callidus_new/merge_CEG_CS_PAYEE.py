...
query = f"""
TRUNCATE TABLE {sfDatabase}.ATO_CEG_STG.CS_PAYEE;
...
query = f"""
INSERT INTO {sfDatabase}.ATO_CEG_STG.CS_PAYEE
(
	TENANTID,
	PAYEESEQ,
	EFFECTIVESTARTDATE,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_PAYEE_STG SRC
WHERE SRC.INSERT_TS = (
	SELECT MAX(INSERT_TS)
	FROM {sfDatabase}.ATO_CEG_STG.CS_PAYEE_STG
)
;
