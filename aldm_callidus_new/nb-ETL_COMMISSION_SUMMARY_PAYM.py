...
-------------- IN CASE OF RERUN ----------------
DELETE FROM {sfDatabase}.PRS_CEG_EXT.COMMISSION_SUMMARY_PAYM
...
INSERT INTO {sfDatabase}.PRS_CEG_EXT.COMMISSION_SUMMARY_PAYM
(
PERIOD_START_DATE,
TRANSACTION_MONTH,
PAYMENT_MONTH,
...
WHERE STMT.SOURCE NOT IN ('Legacy', 'Business Paid')  
  AND STMT.BUS_SERVICE_TYPE = 'PAYM' 
