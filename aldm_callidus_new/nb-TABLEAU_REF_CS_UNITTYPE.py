...
query = f"""
DELETE FROM {sfReportingDatabase}.PRS_SPL_DP.CS_UNITTYPE;
...
query = f"""
INSERT INTO {sfReportingDatabase}.PRS_SPL_DP.CS_UNITTYPE
(
	TENANTID,
	UNITTYPESEQ,
	CREATEDATE,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_UNITTYPE SRC
;
