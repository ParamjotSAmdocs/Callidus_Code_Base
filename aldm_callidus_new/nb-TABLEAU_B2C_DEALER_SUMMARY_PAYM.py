...
DELETE FROM {sfReportingDatabase}.PRS_SPL_DP.DEALER_SUMMARY_REPORT_PAYM;
...
INSERT INTO {sfReportingDatabase}.PRS_SPL_DP.DEALER_SUMMARY_REPORT_PAYM
SELECT
...
WHERE TRIM(UPPER(BUS_SERVICE_TYPE)) ='PAYM' AND IS_POSTED = 0
AND PERIOD_NAME IN (
