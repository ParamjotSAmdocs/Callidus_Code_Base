...
query = f"""
TRUNCATE TABLE {sfDatabase}.ATO_CEG_STG.TBL_FACT_PAYG_DEPOSITS;
...
query = f"""
INSERT INTO {sfDatabase}.ATO_CEG_STG.TBL_FACT_PAYG_DEPOSITS
(
	PARTNER_CODE,
	PERIOD,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.TBL_FACT_PAYG_DEPOSITS_STG SRC
WHERE SRC.INSERT_TS = (
	SELECT MAX(INSERT_TS)
	FROM {sfDatabase}.ATO_CEG_STG.TBL_FACT_PAYG_DEPOSITS_STG
)
;
