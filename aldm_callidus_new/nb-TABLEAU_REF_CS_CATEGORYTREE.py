...
DELETE FROM {sfReportingDatabase}.PRS_SPL_DP.CS_CATEGORYTREE;
...
query = f"""
INSERT INTO {sfReportingDatabase}.PRS_SPL_DP.CS_CATEGORYTREE
(
	TENANTID,
	CATEGORYTREESEQ,
	EFFECTIVESTARTDATE,
...
SELECT
	...
	SRC.INSERT_TS,
	SRC.UPDATE_TS
FROM {sfDatabase}.ATO_CEG_STG.CS_CATEGORYTREE SRC
;
